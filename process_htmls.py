...
prefix overview https://stat.ripe.net/data/prefix-overview/data.json?resource=8.8.8.0/24 (including related prefixes)
...
def fetch_ripestat_asn_html(asn):
    ...
    urls = [f"https://stat.ripe.net/data/as-overview/data.json?resource=AS{asn}", f"https://stat.ripe.net/data/routing-status/data.json?resource=AS{asn}", f"https://stat.ripe.net/data/transfer-history/data.json?resource=AS{asn}"]
